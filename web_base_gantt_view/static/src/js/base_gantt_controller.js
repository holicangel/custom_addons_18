...
export class BaseGanttController extends Component {
    setup() {
        ...
        onWillStart(async () => {
            await loadJS("/web_base_gantt_view/static/src/lib/frappe-gantt.js");
            await loadJS("/web_base_gantt_view/static/src/lib/snap.svg-min.js");
            await loadJS("/web_base_gantt_view/static/src/lib/moment.min.js");
            await loadCSS("/web_base_gantt_view/static/src/lib/frappe-gantt.css");
        });
